...
date: 2017-08-15 13:47:44
categories: 技术
tags: 
    - ElasticSearch
---

> 本文实例中采用Elasticsearch的版本为5.5.1

# 下载
[ZIP](https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-5.5.1.zip)

[TAR](https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-5.5.1.tar.gz)
...
==>> this.base_uri = this.config.base_uri || this.prefs.get("app-base_uri") || "http://10.10.10.10:9200"; # 把localhost修改成你es的服务器地址
